...
const Hero = () => {
  ...
  return (
    <section id="home" className="min-h-screen flex items-center justify-center relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 text-center text-slate-800 relative z-10">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-6 mb-16">
            <button 
              ...
              className="bg-gradient-to-r from-pink-300 to-purple-300 hover:from-pink-400 hover:to-purple-400 text-white px-8 py-4 rounded-full font-semibold text-lg transition-all duration-300 transform hover:scale-105 shadow-lg"
            >
              View My Work
            </button>
            ...
            <div className="flex space-x-6">
              <a 
                ...
                className="text-slate-600 hover:text-slate-800 transition-colors duration-200 transform hover:scale-110"
              >
          ...
          <button 
            onClick={scrollToAbout}
            className="animate-bounce text-slate-600 hover:text-slate-800 transition-colors duration-200"
          >
            <ArrowDown size={32} />
          </button>
        </div>
